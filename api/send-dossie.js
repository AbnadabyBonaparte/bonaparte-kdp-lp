...
export default async function handler(req, res) {
  ...
  const emailHtml = '<!DOCTYPE html>'
    ...
    + '<h1 style="color:#e8e6e1;font-size:22px;font-weight:600;margin:0;line-height:1.3;">Dossi&ecirc; Introdut&oacute;rio</h1>'
    + '</td></tr>'
    ...
    + greeting + 'oc&ecirc; solicitou o Dossi&ecirc; Introdut&oacute;rio da <strong style="color:#e8e6e1;">Cartografia da Soberania Interior</strong>.'
    + '</td></tr>'
    + '<tr><td style="color:#9a9890;font-size:15px;line-height:1.7;padding:0 0 32px 0;">'
    + 'Tr&ecirc;s ensaios sobre o que funciona contra voc&ecirc; enquanto voc&ecirc; funciona bem. Texto aut&ocirc;nomo, denso, sem teaser. Se fizer sentido, o livro existe. Se n&atilde;o, o que est&aacute; aqui j&aacute; &eacute; seu.'
    + '</td></tr>'
    ...
    + 'ACESSAR O DOSSI&Ecirc;'
    + '</a>'
    + '</td></tr>'
    + '<tr><td align="center" style="padding:0 0 20px 0;">'
    + '<p style="color:#9a9890;font-size:14px;text-align:center;margin:0 0 12px 0;">Se o que voc&ecirc; leu fez sentido, a obra completa est&aacute; dispon&iacute;vel.</p>'
    + '</td></tr>'
    ...
    + '<tr><td style="color:#9a9890;font-size:13px;line-height:1.6;padding:0 0 24px 0;text-align:center;">Sem pop-up. Sem escassez. Sem pressa.</td></tr>'
    + '<tr><td style="color:#5a5850;font-size:11px;text-align:center;padding:16px 0 0 0;">'
    + 'Abnadaby Bonaparte &middot; 12 livros publicados<br>'
    + 'Este email foi enviado porque voc&ecirc; solicitou o dossi&ecirc; em casabonaparte.com'
    + '</td></tr>'
  ...
  try {
    ...
    const emailResponse = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: FROM_EMAIL,
        to: email,
        subject: 'Seu Dossie Introdutorio - Casa Bonaparte',
        html: emailHtml,
      }),
    });
